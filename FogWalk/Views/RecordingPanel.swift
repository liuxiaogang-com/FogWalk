        ...
        NavigationStack {
            Form {
                ...
                Section("当前状态") {
                    ...
                    LabeledContent("本次进程已保存", value: "\(recorder.savedPointCount) 点")
                    ...
                    Button("测试当前位置") { recorder.requestCurrentLocation() }
                ...
                Section("权限与后台") {
                    ...
                    LabeledContent("运动识别", value: motionText)
                    ...
                    Text("开始记录后支持切到后台和锁屏，系统会显示定位标识。建议开启“始终”和“精确位置”；运动权限拒绝时使用定位位移判断。")
                        .font(.footnote).foregroundStyle(.secondary)
